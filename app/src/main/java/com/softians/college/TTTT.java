...
public class TTTT extends AppCompatActivity {
   ...
   // String third="http://192.168.0.4/data123/get_tt_third.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue666 = Volley.newRequestQueue(getApplicationContext());





        Toast.makeText(TTTT.this ,myString16, Toast.LENGTH_SHORT).show();


        listView = (ListView) findViewById(R.id.listView);

        StringRequest stringRequest = new StringRequest(Constants.third, new Response.Listener<String>() {
            @Override
            public void onResponse(String response)
            {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TTTT.this,error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });


        requestQueue666.add(stringRequest);
