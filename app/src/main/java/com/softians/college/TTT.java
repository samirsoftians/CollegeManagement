...
public class TTT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue6666 = Volley.newRequestQueue(getApplicationContext());





        Toast.makeText(TTT.this ,myString16, Toast.LENGTH_SHORT).show();


        listView = (ListView) findViewById(R.id.listView);

        StringRequest stringRequest = new StringRequest(Constants.second, new Response.Listener<String>() {
            @Override
            public void onResponse(String response)
            {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(TTT.this,error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });


        requestQueue6666.add(stringRequest);
